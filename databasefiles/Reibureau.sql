...
--
-- Host: db
-- Gegenereerd op: 21 jun 2026 om 19:58
-- Serverversie: 8.4.8
-- PHP-versie: 8.3.30
...
CREATE TABLE `Accomodations` (
  ...
  `RentalCarOption` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL COMMENT 'The availability of rental cars',
...
INSERT INTO `Accomodations` (`AccomodationID`, `Type`, `Stars`, `Lodging`, `RentalCarOption`, `Persons`) VALUES
(1, 'Hotel', 5, 'Logies en ontbijt', 'Not available', 6),
(2, 'Hotel', 5, 'All inclusive', 'Optionele Huurauto', 6),
(3, 'Vakantiehuis', 4, 'Logies', 'Inclusief huurauto', 4),
(4, 'Appartement', 5, 'All inclusive', 'Not available', 2);
...
CREATE TABLE `Trip` (
  ...
  `SaleOption` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT ' ' COMMENT 'Of het scherp geprijsd is, en of kassakorting heeft. Bij geen van beide gewoon leeg laten',
...
(1, 'Zakynthos', 1, 1, 3, 'Via Eindhoven', 905, 'Not available', './assets/img/Zakynthos-beach.jpg'),
(2, 'Zakynthos', 2, 2, 1, 'Via Eindhoven', 905, 'Not available', './assets/img/Zakynthos-beach-2.jpg'),
(3, 'Barcelona', 3, 3, 2, 'Via Düsseldorf', 785, 'Not available', './assets/img/Barcelona.jpg'),
(4, 'Mallorca', 4, 2, 4, 'Via Schiphol', 901, 'Scherp geprijsd', './assets/img/Mallorca-image-1.png'),
(5, 'Aruba', 2, 1, 5, 'Via Amsterdam', 895, 'Kassakorting', './assets/img/Aruba.jpg');
